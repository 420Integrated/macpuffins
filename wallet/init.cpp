...
std::string HelpMessage()
{
    ...
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 1820 or testnet: 11820)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 1784 or testnet: 11784)") + "\n" +
